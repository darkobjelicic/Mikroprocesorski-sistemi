...
#define red2 GPIO_PIN_1
#define red3 GPIO_PIN_2
#define red4 GPIO_PIN_3

#define kolona1 GPIO_PIN_4
#define kolona2 GPIO_PIN_5
#define kolona3 GPIO_PIN_6
#define kolona4 GPIO_PIN_7
...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  if(HAL_GPIO_ReadPin(GPIOA, kolona2) == 1)
	  {
		  flag = 0;
	  }
	  if(HAL_GPIO_ReadPin(GPIOA, kolona3) == 1)
	  {
		  flag = 0;
	  }
	  if(HAL_GPIO_ReadPin(GPIOA, kolona4) == 1)
	  {
		  flag = 0;
	  }
